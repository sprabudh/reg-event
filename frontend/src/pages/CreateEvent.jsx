...
const CreateEvent = () => {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'category') {
            ...
            // Handle boolean checkbox toggles
    ...
    const handleSubmit = (e) => {
        ...
        // Ensure price is properly formatted (empty string becomes 0/null backend side)
        const payload = { ...formData };
        if (payload.price === '') payload.price = 0;

        createEvent(payload)
            .then(() => navigate('/events'))
            .catch(() => setError('Failed to create event. Please check your inputs.'));
    };
